// Command RemoteJobsApiRssFeed-mcp is an MCP server exposing the RemoteJobsApiRssFeed
// SDK as MCP tools.
//
// Two tools are registered:
//
//	RemoteJobsApiRssFeed_list  — list records of an entity
//	RemoteJobsApiRssFeed_load  — load a single record of an entity
//
