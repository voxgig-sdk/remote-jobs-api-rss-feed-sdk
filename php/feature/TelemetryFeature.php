...
// RemoteJobsApiRssFeed SDK telemetry feature
...
class RemoteJobsApiRssFeedTelemetryFeature extends RemoteJobsApiRssFeedBaseFeature
{
    ...
    private function _close(RemoteJobsApiRssFeedContext $ctx, bool $ok): void
    {
