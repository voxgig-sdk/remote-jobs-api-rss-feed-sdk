...
type RemoteJobEntity struct {
	name    string
	client  *core.RemoteJobsApiRssFeedSDK
...
func NewRemoteJobEntity(client *core.RemoteJobsApiRssFeedSDK, entopts map[string]any) *RemoteJobEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RemoteJobEntity) GetName() string { return e.name }
...
func (e *RemoteJobEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RemoteJobEntity) Deleted() bool {
	return e.deleted
}


func (e *RemoteJobEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRemoteJobEntity(e.client, opts)
}

func (e *RemoteJobEntity) Data(args ...any) any {
...
func (e *RemoteJobEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RemoteJob; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RemoteJobEntity) DataTyped(data ...RemoteJob) RemoteJob {
	if len(data) > 0 {
		return typedFrom[RemoteJob](e.Data(asMap(data[0])))
	}
	return typedFrom[RemoteJob](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RemoteJob (all fields
// optional at the wire level).
func (e *RemoteJobEntity) MatchTyped(match ...RemoteJob) RemoteJob {
	if len(match) > 0 {
		return typedFrom[RemoteJob](e.Match(asMap(match[0])))
	}
	return typedFrom[RemoteJob](e.Match())
}
...
func (e *RemoteJobEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RemoteJobEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RemoteJobEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RemoteJobListMatch and returns []RemoteJob. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RemoteJobEntity) ListTyped(reqmatch RemoteJobListMatch, ctrl map[string]any) ([]RemoteJob, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[RemoteJob](res), nil
}



func (e *RemoteJobEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RemoteJobEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RemoteJobEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RemoteJobEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
