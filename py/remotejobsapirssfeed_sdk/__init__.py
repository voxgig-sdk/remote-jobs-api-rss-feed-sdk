...
from remotejobsapirssfeed_sdk.utility import register

# Load features
from remotejobsapirssfeed_sdk.feature.base_feature import RemoteJobsApiRssFeedBaseFeature
from remotejobsapirssfeed_sdk.features import _has_feature, _make_feature
...
class RemoteJobsApiRssFeedSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = RemoteJobsApiRssFeedUtility()
    ...
    def get_utility(self):
        return RemoteJobsApiRssFeedUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RemoteJobsApiRssFeedSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def RemoteJob(self, data=None) -> "RemoteJobEntity":
        ...
        from remotejobsapirssfeed_sdk.entity.remote_job_entity import RemoteJobEntity
