...
// RemoteJobsApiRssFeed SDK utility type

class RemoteJobsApiRssFeedUtility
{
    ...
    public static function copy(RemoteJobsApiRssFeedUtility $src): RemoteJobsApiRssFeedUtility
    {
        $u = new RemoteJobsApiRssFeedUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
