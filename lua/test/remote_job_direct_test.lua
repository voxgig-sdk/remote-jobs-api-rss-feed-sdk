...
describe("RemoteJobDirect", function()
  it("should direct-list-remote_job", function()
    local setup = remote_job_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-remote_job", setup.live and "live" or "unit")
...
function remote_job_direct_setup(mockres)
