...
from projectname_sdk.core.control import RemoteJobsApiRssFeedControl
...
class RemoteJobsApiRssFeedContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = RemoteJobsApiRssFeedControl()
        ...
        if isinstance(sp, RemoteJobsApiRssFeedSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, RemoteJobsApiRssFeedResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RemoteJobsApiRssFeedResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return RemoteJobsApiRssFeedOperation({})
    ...
    def make_error(self, code, msg):
        return RemoteJobsApiRssFeedError(code, msg, self)
