...
import (
	...
	"github.com/voxgig-sdk/remote-jobs-api-rss-feed-sdk/go/entity"
	"github.com/voxgig-sdk/remote-jobs-api-rss-feed-sdk/go/feature"
	_ "github.com/voxgig-sdk/remote-jobs-api-rss-feed-sdk/go/utility"
)
...
// instead of `sdk.NewRemoteJobsApiRssFeedSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *RemoteJobsApiRssFeedSDK  { return NewRemoteJobsApiRssFeedSDK(nil) }
func Test() *RemoteJobsApiRssFeedSDK { return TestSDK(nil, nil) }
