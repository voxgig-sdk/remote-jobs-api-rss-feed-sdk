...
This is an unofficial SDK for the Jobicy Remote Jobs public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/remote-jobs-api-rss-feed` | `npm install @voxgig-sdk/remote-jobs-api-rss-feed` |
| Python | `voxgig-sdk-remote-jobs-api-rss-feed` | `pip install voxgig-sdk-remote-jobs-api-rss-feed` |
| PHP | `voxgig-sdk/remote-jobs-api-rss-feed` | `composer require voxgig-sdk/remote-jobs-api-rss-feed` |
| Golang | `github.com/voxgig-sdk/remote-jobs-api-rss-feed-sdk/go` | `go get github.com/voxgig-sdk/remote-jobs-api-rss-feed-sdk/go` |
| Ruby | `voxgig-sdk-remote-jobs-api-rss-feed` | `gem install voxgig-sdk-remote-jobs-api-rss-feed` |
| Lua | `voxgig-sdk-remote-jobs-api-rss-feed` | `luarocks install voxgig-sdk-remote-jobs-api-rss-feed` |
