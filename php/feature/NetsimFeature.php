...
// RemoteJobsApiRssFeed SDK netsim feature
...
class RemoteJobsApiRssFeedNetsimFeature extends RemoteJobsApiRssFeedBaseFeature
{
    ...
    private function _simulate(RemoteJobsApiRssFeedContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RemoteJobsApiRssFeedContext $ctx, array $applied): void
    {
        $client = $this->client;
