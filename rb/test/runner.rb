...
module RemoteJobsApiRssFeedTestRunner
  ...
  def self.env_override(m)
    live = getenv("REMOTEJOBSAPIRSSFEED_TEST_LIVE")
    override = getenv("REMOTEJOBSAPIRSSFEED_TEST_OVERRIDE")
    ...
    explain = getenv("REMOTEJOBSAPIRSSFEED_TEST_EXPLAIN")
    m["REMOTEJOBSAPIRSSFEED_TEST_EXPLAIN"] = explain if explain && !explain.empty?
