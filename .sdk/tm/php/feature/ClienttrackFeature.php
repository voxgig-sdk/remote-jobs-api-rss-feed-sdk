...
// RemoteJobsApiRssFeed SDK clienttrack feature
...
class RemoteJobsApiRssFeedClienttrackFeature extends RemoteJobsApiRssFeedBaseFeature
{
    ...
    public function PostConstruct(RemoteJobsApiRssFeedContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RemoteJobsApiRssFeed-SDK';
