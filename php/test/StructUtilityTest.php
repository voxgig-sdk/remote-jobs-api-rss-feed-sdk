...
// RemoteJobsApiRssFeed SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = RemoteJobsApiRssFeedOmni::makeStructRunner(
    ...
    {
        return RemoteJobsApiRssFeedOmni::objmodel(RemoteJobsApiRssFeedOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return RemoteJobsApiRssFeedOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return RemoteJobsApiRssFeedOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(RemoteJobsApiRssFeedOmni::structfix($now, Struct::undef()))
                        !== json_encode(RemoteJobsApiRssFeedOmni::structfix($val, Struct::undef()))) {
