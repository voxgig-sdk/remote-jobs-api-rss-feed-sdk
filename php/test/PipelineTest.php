...
// RemoteJobsApiRssFeed SDK pipeline test
//
...
{
    private static function utility(): RemoteJobsApiRssFeedUtility
    {
        return new RemoteJobsApiRssFeedUtility();
    }
    ...
    private static function ctx(array $over = []): RemoteJobsApiRssFeedContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new RemoteJobsApiRssFeedContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new RemoteJobsApiRssFeedOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof RemoteJobsApiRssFeedError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new RemoteJobsApiRssFeedOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = RemoteJobsApiRssFeedMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new RemoteJobsApiRssFeedOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = RemoteJobsApiRssFeedMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new RemoteJobsApiRssFeedOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = RemoteJobsApiRssFeedMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RemoteJobsApiRssFeedSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = RemoteJobsApiRssFeedMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new RemoteJobsApiRssFeedResponse([]),
            'result' => new RemoteJobsApiRssFeedResult([]),
        ]);
        [, $err] = RemoteJobsApiRssFeedMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new RemoteJobsApiRssFeedSpec([]),
            'response' => null,
            'result' => new RemoteJobsApiRssFeedResult([]),
        ]);
        [, $err] = RemoteJobsApiRssFeedMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new RemoteJobsApiRssFeedSpec(['step' => 's']),
            'response' => new RemoteJobsApiRssFeedResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new RemoteJobsApiRssFeedResult([]),
        ]);
        [, $err] = RemoteJobsApiRssFeedMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new RemoteJobsApiRssFeedSpec(['step' => 's']),
            'response' => new RemoteJobsApiRssFeedResponse(self::resp(200, ['v' => 1])),
            'result' => new RemoteJobsApiRssFeedResult([]),
        ]);
        [, $err] = RemoteJobsApiRssFeedMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new RemoteJobsApiRssFeedSpec(['step' => 's']),
            'response' => new RemoteJobsApiRssFeedResponse(self::resp(200, ['v' => 2])),
            'result' => new RemoteJobsApiRssFeedResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        RemoteJobsApiRssFeedMakeResponse::call($ctx);
    ...
    {
        $preset = new RemoteJobsApiRssFeedResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new RemoteJobsApiRssFeedSpec([]),
            'response' => new RemoteJobsApiRssFeedResponse([]),
            'result' => new RemoteJobsApiRssFeedResult([]),
        ...
        [$got, $err] = RemoteJobsApiRssFeedMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new RemoteJobsApiRssFeedResult([])]);
        [, $err] = RemoteJobsApiRssFeedMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new RemoteJobsApiRssFeedSpec([]), 'result' => null]);
        [, $err] = RemoteJobsApiRssFeedMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RemoteJobsApiRssFeedSpec(['step' => 's']),
            'result' => new RemoteJobsApiRssFeedResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new RemoteJobsApiRssFeedOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RemoteJobsApiRssFeedMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RemoteJobsApiRssFeedSpec(['step' => 's']),
            'result' => new RemoteJobsApiRssFeedResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new RemoteJobsApiRssFeedOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RemoteJobsApiRssFeedMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RemoteJobsApiRssFeedResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new RemoteJobsApiRssFeedSpec([]),
            'result' => new RemoteJobsApiRssFeedResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = RemoteJobsApiRssFeedMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RemoteJobsApiRssFeedMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new RemoteJobsApiRssFeedError('boom', 'boom');
        $utility->fetcher = function (RemoteJobsApiRssFeedContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RemoteJobsApiRssFeedSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = RemoteJobsApiRssFeedMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (RemoteJobsApiRssFeedContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = RemoteJobsApiRssFeedMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(RemoteJobsApiRssFeedResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        RemoteJobsApiRssFeedMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (RemoteJobsApiRssFeedContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RemoteJobsApiRssFeedSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = RemoteJobsApiRssFeedMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new RemoteJobsApiRssFeedResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new RemoteJobsApiRssFeedSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = RemoteJobsApiRssFeedMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = RemoteJobsApiRssFeedMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = RemoteJobsApiRssFeedMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new RemoteJobsApiRssFeedResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, RemoteJobsApiRssFeedDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new RemoteJobsApiRssFeedResult(['ok' => false])]);
        $this->expectException(RemoteJobsApiRssFeedError::class);
        RemoteJobsApiRssFeedDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new RemoteJobsApiRssFeedResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', RemoteJobsApiRssFeedMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        RemoteJobsApiRssFeedMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new RemoteJobsApiRssFeedBaseFeature();
        $b = new RemoteJobsApiRssFeedBaseFeature();
        RemoteJobsApiRssFeedFeatureAdd::call($ctx, $a);
        RemoteJobsApiRssFeedFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): RemoteJobsApiRssFeedBaseFeature
    {
        $f = new RemoteJobsApiRssFeedBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        RemoteJobsApiRssFeedFeatureAdd::call($ctx, self::named_feature('a'));
        RemoteJobsApiRssFeedFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        RemoteJobsApiRssFeedFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        RemoteJobsApiRssFeedFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        RemoteJobsApiRssFeedFeatureAdd::call($ctx, $replace);
        ...
        RemoteJobsApiRssFeedFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): RemoteJobsApiRssFeedContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new RemoteJobsApiRssFeedSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RemoteJobsApiRssFeedPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        RemoteJobsApiRssFeedPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new RemoteJobsApiRssFeedResponse(['headers' => null]),
            'result' => new RemoteJobsApiRssFeedResult([]),
        ]);
        RemoteJobsApiRssFeedResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        RemoteJobsApiRssFeedResultBody::call($ctx);
