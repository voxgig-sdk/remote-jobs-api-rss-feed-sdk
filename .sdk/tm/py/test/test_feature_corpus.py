# RemoteJobsApiRssFeed SDK feature corpus test
#
...
def _client(kase):
    ...
    RemoteJobsApiRssFeedSDK(...), not RemoteJobsApiRssFeedSDK.test(...): the `test` feature is
    ...
    return RemoteJobsApiRssFeedSDK(opts)
