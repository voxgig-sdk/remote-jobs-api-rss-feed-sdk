...
// RemoteJobsApiRssFeed SDK timeout feature
...
class RemoteJobsApiRssFeedTimeoutFeature extends RemoteJobsApiRssFeedBaseFeature
{
    ...
    private function _with_timeout(RemoteJobsApiRssFeedContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RemoteJobsApiRssFeedContext $_ctx, float $ms): void
    {
        $client = $this->client;
