# RemoteJobsApiRssFeed SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RemoteJobsApiRssFeedSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RemoteJobsApiRssFeedSDK(...) and RemoteJobsApiRssFeedSDK.test(...) become
#      RemoteJobsApiRssFeedSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "remotejobsapirssfeed_sdk"
_SDK_CLASS = "RemoteJobsApiRssFeedSDK"
