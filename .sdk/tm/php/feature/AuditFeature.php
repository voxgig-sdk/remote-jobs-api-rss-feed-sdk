...
// RemoteJobsApiRssFeed SDK audit feature
...
class RemoteJobsApiRssFeedAuditFeature extends RemoteJobsApiRssFeedBaseFeature
{
    ...
    private function _emit(RemoteJobsApiRssFeedContext $ctx, string $outcome): void
    {
