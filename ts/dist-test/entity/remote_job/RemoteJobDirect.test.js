...
(0, node_test_1.describe)('RemoteJobDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.RemoteJobsApiRssFeedSDK({
    ...
    (0, node_test_1.test)('direct-list-remote_job', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-remote_job', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.REMOTE_JOBS_API_RSS_FEED_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.RemoteJobsApiRssFeedSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['REMOTE_JOBS_API_RSS_FEED_TEST_REMOTE_JOB_ENTID'];
    ...
    const client = new __1.RemoteJobsApiRssFeedSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=RemoteJobDirect.test.js.map