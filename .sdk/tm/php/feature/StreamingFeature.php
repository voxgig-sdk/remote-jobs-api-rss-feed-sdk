...
// RemoteJobsApiRssFeed SDK streaming feature
...
class RemoteJobsApiRssFeedStreamingFeature extends RemoteJobsApiRssFeedBaseFeature
{
    ...
    private function _iterate(RemoteJobsApiRssFeedResult $result): \Generator
    {
    ...
    private function _streamable(RemoteJobsApiRssFeedContext $ctx): bool
    {
