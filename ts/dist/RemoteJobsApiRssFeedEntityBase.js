...
exports.RemoteJobsApiRssFeedEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends RemoteJobsApiRssFeedEntityBase<Advice>`.
class RemoteJobsApiRssFeedEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.RemoteJobsApiRssFeedEntityBase = RemoteJobsApiRssFeedEntityBase;
//# sourceMappingURL=RemoteJobsApiRssFeedEntityBase.js.map