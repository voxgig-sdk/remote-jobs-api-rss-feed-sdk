...
class RemoteJobsApiRssFeedSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = RemoteJobsApiRssFeedHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = RemoteJobsApiRssFeedHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!RemoteJobsApiRssFeedFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, RemoteJobsApiRssFeedFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return RemoteJobsApiRssFeedUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = RemoteJobsApiRssFeedHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = RemoteJobsApiRssFeedHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = RemoteJobsApiRssFeedHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new RemoteJobsApiRssFeedError($op . "_allow",
                "RemoteJobsApiRssFeedSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = RemoteJobsApiRssFeedHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new RemoteJobsApiRssFeedError("graphql_error",
                "RemoteJobsApiRssFeedSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function RemoteJob($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_remote_job === null) {
                $this->_remote_job = new RemoteJobEntity($this, null);
            }
            return $this->_remote_job;
        }
        return new RemoteJobEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new RemoteJobsApiRssFeedSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
