...
// RemoteJobsApiRssFeed SDK ratelimit feature
...
class RemoteJobsApiRssFeedRatelimitFeature extends RemoteJobsApiRssFeedBaseFeature
{
    ...
    private function _acquire(RemoteJobsApiRssFeedContext $ctx): void
    {
    ...
    private function _track(RemoteJobsApiRssFeedContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
