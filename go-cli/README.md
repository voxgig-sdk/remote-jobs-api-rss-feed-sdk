...
AQL-driven CLI and REPL for the RemoteJobsApiRssFeed SDK. Positional arguments are
...
```sh
go build -o remote-jobs-api-rss-feed-cli ./...
```
...
./remote-jobs-api-rss-feed-cli load 1 remote_job
./remote-jobs-api-rss-feed-cli load '{id:1}' remote_job
