...
// RemoteJobsApiRssFeed SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RemoteJobsApiRssFeedSDK::test)
...
{
    private const SDK_CLASS = 'RemoteJobsApiRssFeedSDK';
    ...
    private const SDK_BASE = 'remotejobsapirssfeed_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../remotejobsapirssfeed_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
