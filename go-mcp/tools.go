...
type Args struct {
	Entity string         `json:"entity" jsonschema:"remote_job"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.RemoteJobsApiRssFeedSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "remote-jobs-api-rss-feed_list",
		Description: "List records from RemoteJobsApiRssFeed. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "remote-jobs-api-rss-feed_load",
		Description: "Load a single record from RemoteJobsApiRssFeed. " +
...
func runOp(client *sdk.RemoteJobsApiRssFeedSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.RemoteJobsApiRssFeedSDK, name string) (sdk.RemoteJobsApiRssFeedEntity, error) {
	switch strings.ToLower(name) {
	case "remote_job":
		return client.RemoteJob(nil), nil
