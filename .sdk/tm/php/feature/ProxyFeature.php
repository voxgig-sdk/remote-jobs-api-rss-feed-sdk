...
// RemoteJobsApiRssFeed SDK proxy feature
...
class RemoteJobsApiRssFeedProxyFeature extends RemoteJobsApiRssFeedBaseFeature
{
    ...
    public function init(RemoteJobsApiRssFeedContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RemoteJobsApiRssFeedContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
