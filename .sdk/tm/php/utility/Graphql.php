...
// RemoteJobsApiRssFeed SDK utility: graphql
//
...
class RemoteJobsApiRssFeedGraphql
{
    ...
    // equivalent.
    public static function body(RemoteJobsApiRssFeedContext $ctx): mixed
    {
    ...
    public static function errors(RemoteJobsApiRssFeedContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
