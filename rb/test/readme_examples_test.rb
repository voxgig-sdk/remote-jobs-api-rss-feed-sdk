...
#      offline in seeded test mode (RemoteJobsApiRssFeedSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "RemoteJobsApiRssFeed_sdk.rb")
  SDK_CLASS = "RemoteJobsApiRssFeedSDK"
  ...
  SDK_BASE = "RemoteJobsApiRssFeed_sdk"
