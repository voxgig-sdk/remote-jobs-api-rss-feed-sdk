...
require_relative 'RemoteJobsApiRssFeed_types'
...
class RemoteJobsApiRssFeedSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = RemoteJobsApiRssFeedHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = RemoteJobsApiRssFeedHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, RemoteJobsApiRssFeedFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    RemoteJobsApiRssFeedUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = RemoteJobsApiRssFeedHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = RemoteJobsApiRssFeedHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = RemoteJobsApiRssFeedHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => RemoteJobsApiRssFeedError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue RemoteJobsApiRssFeedError => err
    ...
    if fetched.is_a?(Hash)
      status = RemoteJobsApiRssFeedHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = RemoteJobsApiRssFeedError.new(
        "graphql_error", "RemoteJobsApiRssFeedSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = RemoteJobsApiRssFeedSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
