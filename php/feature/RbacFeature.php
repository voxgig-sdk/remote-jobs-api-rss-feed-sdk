...
// RemoteJobsApiRssFeed SDK rbac feature
...
class RemoteJobsApiRssFeedRbacFeature extends RemoteJobsApiRssFeedBaseFeature
{
    ...
    private function _required(RemoteJobsApiRssFeedContext $ctx): ?string
    {
    ...
    private function _reject(RemoteJobsApiRssFeedContext $ctx, string $required): void
    {
    ...
    private function _track(RemoteJobsApiRssFeedContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
