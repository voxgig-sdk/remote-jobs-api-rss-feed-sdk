...
module RemoteJobsApiRssFeedTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("REMOTE_JOBS_API_RSS_FEED_TEST_LIVE")
    override = getenv("REMOTE_JOBS_API_RSS_FEED_TEST_OVERRIDE")
    ...
    explain = getenv("REMOTE_JOBS_API_RSS_FEED_TEST_EXPLAIN")
    m["REMOTE_JOBS_API_RSS_FEED_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = RemoteJobsApiRssFeedTestRunner
Helpers = RemoteJobsApiRssFeedHelpers
Vs = VoxgigStruct
