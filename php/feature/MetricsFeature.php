...
// RemoteJobsApiRssFeed SDK metrics feature
...
class RemoteJobsApiRssFeedMetricsFeature extends RemoteJobsApiRssFeedBaseFeature
{
    ...
    private function _record(RemoteJobsApiRssFeedContext $ctx, bool $ok): void
    {
