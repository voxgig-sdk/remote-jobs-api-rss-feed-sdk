...
type RemoteJobsApiRssFeedSDK struct {
	Mode     string
...
func (sdk *RemoteJobsApiRssFeedSDK) OptionsMap() map[string]any {
...
func (sdk *RemoteJobsApiRssFeedSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *RemoteJobsApiRssFeedSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *RemoteJobsApiRssFeedSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RemoteJobsApiRssFeedSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *RemoteJobsApiRssFeedSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *RemoteJobsApiRssFeedSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("RemoteJobsApiRssFeedSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *RemoteJobsApiRssFeedSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RemoteJobsApiRssFeedSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("RemoteJobsApiRssFeedSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *RemoteJobsApiRssFeedSDK {
	...
	sdk := NewRemoteJobsApiRssFeedSDK(sdkopts)
	sdk.Mode = "test"
