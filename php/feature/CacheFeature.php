...
// RemoteJobsApiRssFeed SDK cache feature
...
class RemoteJobsApiRssFeedCacheFeature extends RemoteJobsApiRssFeedBaseFeature
{
    ...
    private function _through(RemoteJobsApiRssFeedContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
