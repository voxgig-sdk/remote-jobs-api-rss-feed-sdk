# RemoteJobsApiRssFeed SDK feature test harness
#
...
class _Ctx:
    ...
    def __init__(self, client, utility, op=None, entity=None, ctrl=None):
        ...
        self.out = {}
        self.ctrl = ctrl if ctrl is not None else RemoteJobsApiRssFeedControl()
        self.meta = {}
        self.op = op
        self.entity = entity
        self.spec = None
...
class Harness:
    ...
    def op(self, op="load", entity="widget", method=None, path=None,
        ...
        ctx = _Ctx(self.client, self.utility,
                   ...
                   ctrl=RemoteJobsApiRssFeedControl(ctrl or {}))
