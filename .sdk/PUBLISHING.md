...
|---|---|---|
| `ts/` | @voxgig-sdk/remote-jobs-api-rss-feed-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/remote-jobs-api-rss-feed-sdk \
      --repository voxgig-sdk/remote-jobs-api-rss-feed-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/remote-jobs-api-rss-feed-sdk` shows it, and
`npm trust revoke @voxgig-sdk/remote-jobs-api-rss-feed-sdk --id=<id>` removes it.
