...
func registerSDKWords(r *eng.Registry, client *sdk.RemoteJobsApiRssFeedSDK) {
...
func runOp(client *sdk.RemoteJobsApiRssFeedSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
