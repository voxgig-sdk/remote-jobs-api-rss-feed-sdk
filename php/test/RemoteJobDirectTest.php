...
class RemoteJobDirectTest extends TestCase
{
    public function test_direct_list_remote_job(): void
    {
        $setup = remote_job_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-remote_job", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
